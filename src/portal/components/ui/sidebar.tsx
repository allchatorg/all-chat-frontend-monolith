...
import {Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle,} from "@ads/components/ui/sheet"
import {Skeleton} from "@ads/components/ui/skeleton"
import {Tooltip, TooltipContent, TooltipProvider, TooltipTrigger,} from "@ads/components/ui/tooltip"
    ...
    return (
        ...
        >
            ...
            <div
                ...
                className={cn(
                    "fixed top-0 bottom-10 z-10 hidden w-[var(--sidebar-width)] transition-[left,right,width] duration-200 ease-linear md:flex overflow-hidden",
                    side === "left"
